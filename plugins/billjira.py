...
import re
import json
from atlasianconfig import atlasianconfig
...
def atlassian_jira(user, action, parameter):
    ...
    jira_username = atlasianconfig.get("jira_username")
    jira_password = atlasianconfig.get("jira_password")
...
if __name__ == '__main__':
    ...
    atlassian_jira('Bobby', 'info', 'CM-909')
